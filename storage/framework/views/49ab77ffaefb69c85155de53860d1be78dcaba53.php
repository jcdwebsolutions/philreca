<div id="side-bar" class="side-bar">
    ...
    <div class="rts-sidebar-menu-desktop">
        <a class="logo-1" href="<?php echo e(url('home')); ?>"><img class="logo" src="<?php echo e(asset('assets/images/philreca/logo.png')); ?>" alt="philreca"></a>
        <a class="logo-2" href="<?php echo e(url('home')); ?>l"><img class="logo" src="<?php echo e(asset('assets/images/philreca/logo.png')); ?>" alt="philreca"></a>
        <a class="logo-3" href="<?php echo e(url('home')); ?>"><img class="logo" src="<?php echo e(asset('assets/images/philreca/logo.png')); ?>" alt="philreca"></a>
        <a class="logo-4" href="<?php echo e(url('home')); ?>"><img class="logo" src="<?php echo e(asset('assets/images/philreca/logo.png')); ?>" alt="philreca"></a>
        ...
        <div class="body-mobile d-block d-xl-none">
            <nav class="nav-main mainmenu-nav">
                <ul class="mainmenu">
                    ...
                    <li class="has-droupdown">
                        <a class="nav-link" href="<?php echo e(url('events')); ?>">News and Updates</a>
                        <ul class="submenu menu-link3">
...
</div><?php /**PATH /Users/gvtech-jaycee/JCD/Philreca/philreca/resources/views/layout/sidebar.blade.php ENDPATH**/ ?>