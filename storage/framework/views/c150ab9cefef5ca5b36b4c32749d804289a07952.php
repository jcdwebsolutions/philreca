<div class="rts-footer-area footer-three rts-section-gapTop footer-bg-2 jcd-bg">
                                ...
                                <div class="info-wrapper">
                                    <div class="single">
                                        ...
                                        <div class="info">
                                            ...
                                            <a href="#">8967-1580
                                                <br>
                                                0917-850-6830 <br> 0939-905-2206</a>
                                        </div>
                                    </div>
                                    <div class="single">
                                        <ul class="icon">
                                    ...
                                    <div class="single">
                                        ...
                                        <div class="info">
                                            ...
                                            <a href="#">2nd Floor, PNB Building, No. 92 West Avenue, <br>
                        ...
                        <div class="footer-one-single-wized">
                            ...
                            <div class="quick-link-inner">
                                <ul class="links">
                                    ...
                                    <li><a href="#"><i class="far fa-arrow-right"></i> Electric Cooperatives</a></li>
                                    <li><a href="#"><i class="far fa-arrow-right"></i> Allied Organization</a></li>
                                    <li><a href="#"><i class="far fa-arrow-right"></i> Issuances</a></li>
                                </ul>
                                <ul class="links margin-left-70">
                                    <li><a href="#"><i class="far fa-arrow-right"></i>Resource Center</a></li>
                                    <li><a href="#"><i class="far fa-arrow-right"></i>Publications</a></li>
                                    <li><a href="#"><i class="far fa-arrow-right"></i>Events</a></li>
                                    <li><a href="#"><i class="far fa-arrow-right"></i>News and Updates</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <div class="copyright-area ptb--20 jcd-bg-dark">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <p class="disc text-center">
                        PHILRECA - Copyright 2023. All rights reserved.
                    </p>
                </div>
            </div>
        </div>
...
</html><?php /**PATH /Users/gvtech-jaycee/JCD/Philreca/philreca/resources/views/layout/footer.blade.php ENDPATH**/ ?>